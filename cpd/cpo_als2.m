...
for iter = 1:param.maxiters
    ...
    % CP-ALS-2
    Z = khatrirao(Uc(param.orthomodes));
    G = Xm * Z;
    ...
    if numel(nonorthomodes) == 1
        ...
        for r = 1:R
            if numel(nonorthomodes)>2
                ...
                Pr1 = mtucker_als(tensor(reshape(G(:,r),I(nonorthomodes))),...
                    ones(1,numel(nonorthomodes)),optsrank1);
            ...
            elseif numel(nonorthomodes)==2
                ...
                U{nonorthomodes(2)}(:,r) = conj(vn(:,maxid(1)))*sn;
